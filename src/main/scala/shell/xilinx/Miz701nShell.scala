...
//}
//
//class SDIOMiz701nOverlay(val shell: Miz701nShell, val name: String, params: SDIOOverlayParams)
...
//
//class ChipLinkMiz701nOverlay(val shell: Miz701nShell, val name: String, params: ChipLinkOverlayParams)
...
//}
//
//case object Miz701nDDRSize extends Field[BigInt](0x40000000L * 1) // 1GB
//class DDRMiz701nOverlay(val shell: Miz701nShell, val name: String, params: DDROverlayParams)
//  extends DDROverlay[XilinxMiz701nMIGPads](params)
//{
//  val size = p(Miz701nDDRSize)
//
//  val migParams = XilinxMiz701nMIGParams(address = AddressSet.misaligned(params.baseAddress, size))
//  val mig = LazyModule(new XilinxMiz701nMIG(migParams))
...
//  def ioFactory = new XilinxMiz701nMIGPads(size)
//
//  InModuleBody { ioNode.bundle <> mig.module.io }
//
//  shell { InModuleBody {
//    require (shell.sys_clock.isDefined, "Use of DDRMiz701nOverlay depends on SysClockMiz701nOverlay")
...
//}
//
//class PCIeMiz701nOverlay(val shell: Miz701nShell, val name: String, params: PCIeOverlayParams)
//  extends PCIeOverlay[XilinxMiz701nPCIeX1Pads](params)
//{
//  val pcie = LazyModule(new XilinxMiz701nPCIeX1)
...
//  def ioFactory = new XilinxMiz701nPCIeX1Pads
//
...
//  val chiplink  = Overlay(ChipLinkOverlayKey)  (new ChipLinkMiz701nOverlay(_, _, _))
//  val ddr       = Overlay(DDROverlayKey)       (new DDRMiz701nOverlay     (_, _, _))
//  val pcie      = Overlay(PCIeOverlayKey)      (new PCIeMiz701nOverlay    (_, _, _))
//  val uart      = Overlay(UARTOverlayKey)      (new UARTMiz701nOverlay    (_, _, _))
//  val sdio      = Overlay(SDIOOverlayKey)      (new SDIOMiz701nOverlay    (_, _, _))
